...
namespace MVVMDataBinding
{
    ...
    public class CashRegisterModelView : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Gets or sets the number of One dollar coins in the cash register
        /// </summary>
        public int Dollars
        {
            get => drawer.Dollars;
        ...
        /// <summary>
        /// Gets or sets the number of one dollar bills in the cash register
        /// </summary>
        public int Ones
        {
            get => drawer.Ones;
        ...
        /// <summary>
        /// Gets or sets the number of two dollar bills in the cash register
        /// </summary>
        public int Twos
        {
            get => drawer.Twos;
        ...
        /// <summary>
        /// Gets or sets the number of 5 dollar bills in the cash register
        /// </summary>
        public int Fives
        {
            get => drawer.Fives;
        ...
        /// <summary>
        /// Gets or sets the number of 10 dollar bills in the cash register
        /// </summary>
        public int Tens
        {
            get => drawer.Tens;
        ...
        /// <summary>
        /// Gets or sets the number of 20 dollar bills in the cash register
        /// </summary>
        public int Twenties
        {
            get => drawer.Twenties;
        ...
        /// <summary>
        /// Gets or sets the number of 50 dollar bills in the cash register
        /// </summary>
        public int Fifties
        {
            get => drawer.Fifties;
        ...
        /// <summary>
        /// Gets or sets the number of 100 dollar bills in the cash register
        /// </summary>
        public int Hundreds
        {
            get => drawer.Hundreds;
